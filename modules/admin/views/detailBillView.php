...
<div class="container">
    <div class="detail-bill">
        ...
        <div class="order-status">
            ...
            <p><strong>Tình trạng:</strong><?php if($bill['status']==0) echo "<div style='color:red;'>Đang chờ xác nhận<div/>"; else if($bill['status']==1) echo "<div style='color:yellow;'>Đã xác nhận<div/>"; else if($bill['status']==2) echo "<div style='color:green;'>Đã giao hàng<div/>"; else echo 'Đã hủy'?></p>
        </div>
    </div>
</div>
